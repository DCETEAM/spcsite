 ...
 <head>
     ...
     <style>
         ...
         * {
         ...
         ..btn-send:hover textarea:focus {
             outline: none;
             border-color: #00AFF0;
             box-shadow: 0 0 6px rgba(0, 175, 240, 0.3);
         }
     ...
     <section class="contact-section">
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-md-6">
                     <div class="contact-form">
                         ...
                         <form action="{{ route('contact.send') }}" method="POST">
                             ...
                             <div class="form-group">
                                 <label>Message</label>
                                 <textarea name="message" rows="4" placeholder="Text your message" required></textarea>
                             </div>
                 ...
                 <!-- Map -->
                 <div class="col-md-6 c-margin-cointainer">
                     <div class="contact-map">
                         <iframe
                             src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3934.333684685696!2d77.968131!3d9.5664768!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xee473e2064af6993!2sSenthil+Plastic+Industries!5e0!3m2!1sen!2sin!4v1540899401259"
                             width="100%" height="580" style="border:0; border-radius:12px;" allowfullscreen=""
                             loading="lazy">
                         </iframe>
                     </div>
                 </div>
             ...
             <div class="row contact-info">
                 <div class="col-md-12 text-center">
                     <img src="{{ asset('assets/img/item2.png') }}" class="footer-logos" alt="SPC Logo">
                     <h4>Senthil Plastic Containers Pvt Ltd</h4>

                     <h5 class="section-title">Visit our stores</h5>
                     <ul class="info-list">
                         <li>📍 4/422, V.O.C. Nagar, Allampatti(Via), Virudhunagar, TN-626001</li>
                         <li>📞 +91 98439 09609 | 80932 86199 | +91 93674 10444</li>
                         <li>📱 Marketing Manager : 63694 99561</li>
                         <li>✉️ senthilplasticcontainers@gmail.com</li>
                     </ul>
                 </div>
             </div>
         </div>
