 ...
 <head>
     ...
     <title>40 Litre Heavy-Duty Plastic Bucket for Industrial Use | [SPC PLASTIC COMPANY]</title>

     <meta name="description"
         content="Wholesale supplier of 40 Litre industrial plastic buckets  Features superior chemical resistance, tamper-evident lids, and heavy-duty polymer construction for bulk storage.">

     <link rel="canonical" href="[Full URL of this 40Ltr Product Page]">

     <meta property="og:title" content="40 Litre Industrial Plastic Bucket  Supplier">
     <meta property="og:description"
         content="Heavy-duty 40Ltr industrial plastic containers for paints, chemicals, and lubricants.">
     ...
     <section class="product-details" id="product03">
         <div class="container">
             <div class="product-wrapper">
                 ...
                 <div class="product-info">
                     <h1 class="product-title">103Ltr Premium Plastic Bucket</h1>
                     ...
                     <div class="product-buttons">
                         <a href="{{ route('contact') }}" class="btn primary-btn">Enquire Now</a>
 ...
 <section class="related-products py-5">
     <div class="container">
         <h2 class="section-title">Related High-Capacity Industrial Pails</h2>
         <div class="product-grid">
             ...
             <div class="product-card">
                 ...
                 <img src="{{ asset('assets/img/bucketk5.png') }}" alt="10 Litre P10 Plastic Container">
                 <h3>10L P10 Industrial Pail</h3>
             ...
             <div class="product-card">
                 ...
                 <button class="fav-btn" aria-label="Add to favorites"><i class="fa-regular fa-heart"></i></button>
                 <img src="{{ asset('assets/img/bucketk5.png') }}" alt="K10 Plastic Drum">
                 <h3>K10 Plastic Drum</h3>
                 <div class="stars" aria-label="5 out of 5 stars">...</div>
             </div>
             ...
             <div class="product-card">
                 ...
                 <button class="fav-btn" aria-label="Add to favorites"><i class="fa-regular fa-heart"></i></button>
                 <img src="{{ asset('assets/img/bucketk5.png') }}"
                     alt="5 Litre Chemical-Resistant Plastic Bucket K5">
                 <h3>5L K5 Chemical Pail</h3>
                 <div class="stars" aria-label="5 out of 5 stars">...</div>
             </div>

             <div class="product-card">
                 <span class="badge-label">Hot</span>
                 <button class="fav-btn" aria-label="Add to favorites"><i
                         class="fa-regular fa-heart"></i></button>
                 <img src="{{ asset('assets/img/bucketk5.png') }}" alt="20 Litre P20 Plastic Pail">
                 <h3>20L P20 Plastic Pail</h3>
                 <div class="stars" aria-label="5 out of 5 stars">...</div>
             </div>
