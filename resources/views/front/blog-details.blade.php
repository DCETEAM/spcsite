...
.blog-content img {
    ...
    height: auto;
     ...
     <body>
         ...
         <section class="single-blog-container mt-8" style="margin-top: 70px;">
             <div class="container">
    ...
    <div class="blog-content-wrapper">
        ...
        {{-- <div class="blog-img">
            <img src="{{ asset('storage/' . $blog->image) }}" 
                 alt="{{ $blog->title }}" class="blog-banner">
        </div> --}}
...
<aside class="blog-sidebar">
    ...
    <div class="sidebar-widget recent-posts">
        ...
        <ul>
            @foreach ($recent as $r)
            <li>
                <i class="fas fa-chevron-right recent-icon"></i>

                <img src="{{ asset('storage/' . $r->image) }}" 
                     alt="{{ $r->title }}">

                <div>
                    <a href="{{ route('blogs.details', $r->slug) }}">
                        {{ $r->title }}
                    </a>

                    <time>
                        <i class="far fa-clock icon-small"></i>
                        {{ \Carbon\Carbon::parse($r->publish_date)->format('F d, Y') }}
                    </time>

                    <!-- Summernote content preview (clean & trimmed) -->
                    <p class="recent-summary">
                        {!! Str::limit(strip_tags($r->long_description), 100) !!}
                    </p>
