...
<head>
    ...
    <meta name="description"
        content="A leading manufacturer of durable plastic containers, buckets, and pails for the Paint, Food, Chemical, and Agro industries. Specializing in leak-proof, high-quality HDPE containers with premium IML and Screen Printing. Get a quote today.">
    ...
    <section class="hero" id="home">
        <div class="hero-slider">
            <div class="hero-slide active"
                style="
        background-image: url('{{ asset('assets/img/spc4.webp') }}'); ">
                <div class="hero-content">
                </div>
            </div>
            <div class="hero-slide" style="
        background-image: url('{{ asset('assets/img/spc3.webp') }}');">
                <div class="container">
                    <div class="hero-content">
            ...
            <div class="hero-slide" style="
            background-image: url('{{ asset('assets/img/spc2.webp') }}'); ">

            </div>
            <div class="hero-slide" style="
        background-image: url('{{ asset('assets/img/spc8.webp') }}'); ">
                <div class="container">
                    <div class="hero-content">
            ...
            <div class="hero-slide" style="
            background-image: url('{{ asset('assets/img/spc1.webp') }}');">
                <div class="container">
                    <div class="hero-content">
                        {{-- <h1>Custom Designs for Your Brand</h1>
                        <p>
                            Stand out with bespoke packaging solutions tailored to your
    ...
    <section class="facilities-tabs mt-8" id="facilities">
        <div class="container">
            ...
            <div class="facilities-content">
                ...
                @foreach ($facilities as $facility)
                    <div class="facility-panel-split {{ $loop->first ? 'active' : '' }}"
