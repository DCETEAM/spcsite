 ...
 <head>
     ...
     <section class="product-details" id="product01">
         <div class="container">
             <div class="product-wrapper">
                 ...
                 <div class="product-gallery">
                     <div class="main-image">
                         <img id="mainImage" src="{{ asset('assets/img/bucketk5.png') }}" alt="5Ltr Bucket">
                     </div>
          ...
          <img class="thumb" src="{{ asset('assets/img/bucket3.png') }}" alt="Thumb 3" onclick="changeImage(this)">
                 ...
                 <div class="product-info">
                     <h1 class="product-title">5Ltr Premium Plastic Bucket</h1>
